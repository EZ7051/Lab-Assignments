...
import java.io.Serializable;
	...
	public class SerAndDser {
		public static void main(String[] args) {
			Employee emp = new Employee("Ejaz", "65", new Address(2, "APHB", "Ap"), 10000);
			try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(new File("Ejaz.ser")))) {
			...
			try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File("Ejaz.ser")))) {
