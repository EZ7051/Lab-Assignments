...
class Car extends Vehicle {
	...
	public void display() {
		...
		System.out.println("Doors: " + this.getNoOfDoor());
	}
}
...
public class Application {
	public static void main(String[] args) {
		...
		if(choice==1) {
			...
			System.out.println("pls Enter no. of wheels: ");
			int noOfWheel=sc.nextInt();
			System.out.println("pls Enter no. of passengers: ");
			...
			System.out.println("pls Enter no. of passengers: ");
			int noOfPassenger=sc.nextInt();
			System.out.println("pls Enter no. of doors: ");
